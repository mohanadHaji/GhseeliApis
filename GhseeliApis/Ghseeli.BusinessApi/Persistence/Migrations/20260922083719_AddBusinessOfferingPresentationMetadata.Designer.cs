...
namespace Ghseeli.BusinessApi.Persistence.Migrations
{
    ...
    [Migration("20260922083719_AddBusinessOfferingPresentationMetadata")]
    partial class AddBusinessOfferingPresentationMetadata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ghseeli.BusinessApi.Models.BusinessVertical", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("BusinessVerticals", "dbo");

                    b.HasData(
                        new
                        {
                            Id = new Guid("a842f536-17b7-4be6-a18d-1bdc6245094c"),
                            Code = "car_wash",
                            CreatedAtUtc = new DateTime(2026, 8, 25, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsActive = true,
            ...
            modelBuilder.Entity("Ghseeli.BusinessApi.Models.CompanyBusinessVertical", b =>
                {
                    b.Property<Guid>("CompanyId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("CompanyId", "BusinessVerticalId");

                    b.HasIndex("CompanyId")
                        .IsUnique()
                        .HasFilter("[IsPrimary] = 1 AND [IsActive] = 1");

                    b.HasIndex("BusinessVerticalId", "IsActive");

                    b.ToTable("CompanyBusinessVerticals", "dbo", t =>
                        {
                            t.HasCheckConstraint("CK_CompanyBusinessVerticals_PrimaryActive", "[IsPrimary] = 0 OR [IsActive] = 1");
                        });
                });
            ...
            modelBuilder.Entity("Ghseeli.BusinessApi.Models.ServiceCategory", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "BusinessVerticalId");
            ...
            modelBuilder.Entity("Ghseeli.BusinessApi.Models.VehicleWorkOrderDetails", b =>
                {
                    ...
                    b.ToTable("VehicleWorkOrderDetails", "dbo");
                });
            ...
            modelBuilder.Entity("Ghseeli.BusinessApi.Models.AppointmentReservation", b =>
                {
                    b.HasOne("Ghseeli.BusinessApi.Models.BusinessVertical", "BusinessVertical")
                        .WithMany()
            ...
            modelBuilder.Entity("Ghseeli.BusinessApi.Models.ServiceCategory", b =>
                {
                    ...
                    b.HasOne("Ghseeli.BusinessApi.Models.CompanyBusinessVertical", "CompanyBusinessVertical")
                        .WithMany()
                        .HasForeignKey("CompanyId", "BusinessVerticalId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("CompanyBusinessVertical");
                });
            ...
            modelBuilder.Entity("Ghseeli.BusinessApi.Models.VehicleWorkOrderDetails", b =>
                {
                    b.HasOne("Ghseeli.BusinessApi.Models.WorkOrder", "WorkOrder")
                        ...
                        .HasForeignKey("Ghseeli.BusinessApi.Models.VehicleWorkOrderDetails", "WorkOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Ghseeli.BusinessApi.Models.Company", b =>
                {
                    ...
                    b.Navigation("BusinessVerticals");
