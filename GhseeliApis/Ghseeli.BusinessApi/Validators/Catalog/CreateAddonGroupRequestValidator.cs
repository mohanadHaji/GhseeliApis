...
{
    public CreateAddonGroupRequestValidator(IValidator<CreateAddonChoiceRequest> createAddonChoiceValidator)
    {
        ...
        RuleForEach(request => request.Choices!)
            .SetValidator(createAddonChoiceValidator)
            .When(request => request.Choices is not null);
    }
}
