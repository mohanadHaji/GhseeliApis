...
internal static class CatalogTestSupport
{
    ...
    public static CatalogSnapshotResponse CreateSnapshot(
        ...
        string? offeringQualifierHe = null,
        CatalogOfferingBadgeCode? offeringBadgeCode = null,
                ...
                new CatalogSnapshotCategory
                {
                    ...
                    [
                        new CatalogSnapshotOffering
                        {
                            ...
                            QualifierAr = offeringQualifierAr,
                            QualifierHe = offeringQualifierHe,
                            BadgeCode = offeringBadgeCode,
                            BasePrice = 79.5m,
                            DurationMinutes = 30,
