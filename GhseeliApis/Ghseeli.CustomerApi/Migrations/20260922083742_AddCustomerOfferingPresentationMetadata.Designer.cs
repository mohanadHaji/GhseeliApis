...
namespace Ghseeli.CustomerApi.Migrations
{
    ...
    [Migration("20260922083742_AddCustomerOfferingPresentationMetadata")]
    partial class AddCustomerOfferingPresentationMetadata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GhseeliApis.Models.CatalogOfferingReadModel", b =>
                {
                    ...
                    b.Property<string>("QualifierAr")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("QualifierHe")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("GhseeliApis.Models.CatalogProviderReadModel", b =>
                {
                    ...
                    b.Property<string>("BusinessVerticalCode")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)")
                        .HasDefaultValue("car_wash");
            ...
            modelBuilder.Entity("GhseeliApis.Models.CustomerOtpChallenge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CustomerOtpChallenges", "dbo");
                });
            ...
            modelBuilder.Entity("GhseeliApis.Models.CustomerPaymentIdempotencyRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GhseeliApis.Models.CustomerRefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CustomerRefreshTokens", "dbo");
                });
            ...
            modelBuilder.Entity("GhseeliApis.Models.CustomerPayment", b =>
                {
                    b.HasOne("GhseeliApis.Models.CustomerBooking", "CustomerBooking")
                        .WithOne("Payment")
                        .HasForeignKey("GhseeliApis.Models.CustomerPayment", "CustomerBookingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
