...
public sealed class PricingController : ControllerBase
{
    ...
    private readonly IValidator<CreateCheckoutDraftRequest> _requestValidator;
    private readonly IAppLogger _logger;

    public PricingController(
        ICheckoutPricingService service,
        IValidator<GetCheckoutDraftRequest> queryValidator,
        IValidator<CreateCheckoutDraftRequest> requestValidator,
        IAppLogger logger)
    {
        _service = service;
    ...
    [ProducesResponseType<DirectCheckoutPricingResponse>(StatusCodes.Status200OK)]
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogWarning($"Direct pricing failed with code {exception.Code}.");
        ...
        CancellationToken cancellationToken)
    {
        ...
        _logger.LogWarning(
            $"Pricing request validation failed with {validation.Errors.Count} error(s).");
